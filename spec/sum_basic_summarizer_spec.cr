...
describe Cadmium::Summarizer::SumBasic do
  subject = Cadmium::Summarizer::SumBasic.new
  ...
  it "should summarize text via String#summarize" do
    hume_text.summarize(Cadmium::Summarizer::SumBasic).should eq(summary_length[5])
  end
end
